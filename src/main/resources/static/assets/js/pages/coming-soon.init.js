...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var countDown = setInterval(function () {
        ...
        var countDownBlock = '<div class="countdownlist-item">'+
                                '<div class="count-title text-truncate">Days</div>'+'<div class="count-num">'+ days +'</div>'+
                            '</div>'+
                            '<div class="countdownlist-item">'+
                                '<div class="count-title text-truncate">Hours</div>'+'<div class="count-num">'+ hours +'</div>'+
                            '</div>'+
                            '<div class="countdownlist-item">'+
                                '<div class="count-title text-truncate">Minutes</div>'+'<div class="count-num">'+ minutes +'</div>'+
                            '</div>'+
                            '<div class="countdownlist-item">'+
                                '<div class="count-title text-truncate">Seconds</div>'+'<div class="count-num">'+ seconds +'</div>'+
                            '</div>';
