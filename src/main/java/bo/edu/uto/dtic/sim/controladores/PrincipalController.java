...
import bo.edu.uto.dtic.sim.mapas.AccesoMapa;
import bo.edu.uto.dtic.sim.mapas.AccesoUsuarioMapa;
import bo.edu.uto.dtic.sim.mapas.RolMapa;
...
public class PrincipalController {
	...
	public ModelAndView index(HttpServletRequest request, HttpServletResponse response) {
		...
		ses.setAttribute("__direccion", "/sim/");
